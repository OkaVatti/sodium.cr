...
describe Sodium::Cipher::Aead::ChaCha20Poly1305 do
  ...
  it "deterministically encrypts and decrypts with known key/nonce" do
    ...
    nonce = "0700000040414243".hexbytes
    ...
    ct = Sodium::Cipher::Aead::ChaCha20Poly1305.encrypt_static(plaintext, nonce, key, additional: ad)
    dec = Sodium::Cipher::Aead::ChaCha20Poly1305.decrypt_static(ct, nonce, key, additional: ad)
